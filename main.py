...
class Enemy():
    def __init__(self,name,x,y):
        ...
        self.img = pygame.transform.scale(self.img,(135,135))
        self.pos = (self.x,self.y)
        ...
        self.width = 40
        self.height = 70 
        self.hitbox = (self.x,self.y+17,self.width,self.height)
...
something1 = Enemy("name of enemy 1",90,450)
something2 = Enemy("name of enemy 2",450,90)
...
while running:
    ...
    mari.hitbox = (mari.x-2,mari.y-1,300,50)
    ...
    if gameState == "Main":
        ...
        player.posXHb = (player.x+player.xOffset+tileSize,player.y+player.yOffset , tileSize,tileSize)
        player.negXHb = (player.x+player.xOffset -tileSize ,player.y+player.yOffset , tileSize,tileSize)
        player.posYHb = (player.x+player.xOffset,player.y-tileSize+player.yOffset , tileSize,tileSize)
        player.negYHb = (player.x+player.xOffset,player.y+tileSize+player.yOffset , tileSize,tileSize)

        player.posXHb = pygame.draw.rect(screen,"red",player.posXHb,1 )
        player.negXHb = pygame.draw.rect(screen,"red",player.negXHb,1 )
        player.posYHb = pygame.draw.rect(screen,"red",player.posYHb,1 )
        player.negYHb = pygame.draw.rect(screen,"red",player.negYHb,1 )
