...
class Potion():
    def __init__(self,x,y):
        self.x = x
        self.y = y
        self.img = pygame.image.load("healthPotion.png")
...
#adding borders which do not work but you see i tried
tileY = 0
for row in map:
    tileX = 0
    for tile in row:
            tileX += 1
            if int(tile) == 15:
                borders.append(pygame.draw.rect(screen,"orange",(tileX * tileSize-tileSize, tileY * tileSize-tileSize,tileSize,tileSize)))
            if int(tile) == 20:
                borders.append(pygame.draw.rect(screen,"orange",(tileX * tileSize-(tileSize*2), tileY * tileSize,tileSize,tileSize)))
            if int(tile) == 22:
                borders.append(pygame.draw.rect(screen,"orange",(tileX * tileSize, tileY * tileSize,tileSize,tileSize)))
            if int(tile) == 27:
                borders.append(pygame.draw.rect(screen,"orange",(tileX * tileSize-tileSize, tileY * tileSize,tileSize,tileSize)))
            if int(tile) == 14:
                borders.append(pygame.draw.rect(screen,"orange",(tileX * tileSize-tileSize, tileY * tileSize-tileSize,tileSize,tileSize)))
                borders.append(pygame.draw.rect(screen,"orange",(tileX * tileSize-(tileSize*2), tileY * tileSize,tileSize,tileSize)))
            if int(tile) == 16:
                borders.append(pygame.draw.rect(screen,"orange",(tileX * tileSize-tileSize, tileY * tileSize-tileSize,tileSize,tileSize)))
                borders.append(pygame.draw.rect(screen,"orange",(tileX * tileSize+3, tileY * tileSize,tileSize,tileSize)))
            if int(tile) == 26:
                borders.append(pygame.draw.rect(screen,"orange",(tileX * tileSize-(tileSize*2), tileY * tileSize,tileSize,tileSize)))
                borders.append(pygame.draw.rect(screen,"orange",(tileX * tileSize-tileSize, tileY * tileSize,tileSize,tileSize)))
            if int(tile) == 28:
...
while running:
    ...
    if gameState == "Main":
        ...
        def displayNpcText():
            ...
            dialogBox = pygame.image.load('dialogBox.png')
